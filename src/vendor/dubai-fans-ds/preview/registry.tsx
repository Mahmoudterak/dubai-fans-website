...
import { BrandLogoDemo } from './demos/brand-logo';
...
export const DESIGN_SYSTEM = {
  title: 'Dubai Fans Design System',
  description:
    'نظام التصميم الموحّد لمنصة دبي فانز — ألوان، خطوط، مسافات، ومكونات جاهزة لبناء الواجهات بسرعة واتساق.',
} as const;
    ...
    entries: [
      {
        id: 'brand-logo',
        name: 'Logo & colors',
        description: 'الشعار الرسمي وألوان العلامة التجارية وقواعد الاستخدام.',
        Page: BrandLogoDemo,
      },
    ],
  },
